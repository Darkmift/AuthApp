...
(1, 1, 1, 1, '2018-04-19 13:00:39', '2018-04-19 13:00:39', 0, 0, ''),
(2, 1, 2, 1, '2018-04-19 13:00:39', '2018-04-19 13:00:39', 0, 0, ''),
(3, 2, 2, 3, '2018-04-19 13:00:39', '2018-04-19 13:00:39', 0, 0, '');
...
INSERT INTO `students` (`id`, `email`, `name`, `phone`, `password`, `created_at`, `updated_at`, `is_active`, `added_by`) VALUES
(1, 'test1@ts.ts', 'test one student', '0505556677', '$2y$10$S7.v0IVAKy9Mah3gdSBpae1GXciYyFInx8VHIP9ocYI5/q9ieGKbOv', '2018-04-19 15:29:19', '2018-04-19 12:59:53', 1, 'himself'),
(2, 'test2@ts.ts', 'test two student', '0505556677', '$2y$10$S7.v0IVAKy9Mah3gdSBpae1GXciYyFInx8VHIP9ocYI5/q9ieGKbOv', '2018-04-19 15:29:19', '2018-04-19 12:59:53', 1, 'himself'),
(3, 'test3@ts.ts', 'test three student', '0505556677', '$2y$10$S7.v0IVAKy9Mah3gdSBpae1GXciYyFInx8VHIP9ocYI5/q9ieGKbOv', '2018-04-19 15:29:19', '2018-04-19 12:59:53', 1, 'himself'),
(4, 'test4@ts.ts', 'test four student', '0505556677', '$2y$10$S7.v0IVAKy9Mah3gdSBpae1GXciYyFInx8VHIP9ocYI5/q9ieGKbOv', '2018-04-19 15:29:19', '2018-04-19 12:59:53', 0, 'himself'),
(5, 'test5@ts.ts', 'test five student', '0505556677', '$2y$10$S7.v0IVAKy9Mah3gdSBpae1GXciYyFInx8VHIP9ocYI5/q9ieGKbOv', '2018-04-19 15:29:19', '2018-04-19 12:59:53', 1, 'himself'),
(6, 'aone@ts.ts', 'Student test Aone', '', '$2y$10$SYXt4siGaP89vPqWaOghfe8l2jahcU.7kQvAVU8IBkZvip0buVDg6', '2018-04-19 14:29:38', '2018-04-19 14:29:38', 1, 'himself');
...
INSERT INTO `users` (`id`, `email`, `name`, `phone`, `password`, `role`, `created_at`, `updated_at`, `is_active`, `added_by`) VALUES
(1, 'test1@ts.ts', 'test one user', '0505556677', '$2y$10$iLL9pCb3xcXH42mrYxBasOzEdJX3ygGoux6inyVantUKmKaAK7IBm', '1', '2018-04-19 12:59:53', '2018-04-19 12:59:53', 1, 'himself'),
(2, 'test2@ts.ts', 'test two user admin lvl 2', '0505556677', '$2y$10$iLL9pCb3xcXH42mrYxBasOzEdJX3ygGoux6inyVantUKmKaAK7IBm', '2', '2018-04-19 12:59:53', '2018-04-19 12:59:53', 1, 'himself'),
(3, 'test3@ts.ts', 'test three user admin owner', '0505556677', '$2y$10$iLL9pCb3xcXH42mrYxBasOzEdJX3ygGoux6inyVantUKmKaAK7IBm', '3', '2018-04-19 12:59:53', '2018-04-19 12:59:53', 1, 'himself'),
(4, 'test4@ts.ts', 'test four user', '0505556677', '$2y$10$iLL9pCb3xcXH42mrYxBasOzEdJX3ygGoux6inyVantUKmKaAK7IBm', '1', '2018-04-19 12:59:53', '2018-04-19 12:59:53', 0, 'himself'),
(5, 'test5@ts.ts', 'test five user', '0505556677', '$2y$10$iLL9pCb3xcXH42mrYxBasOzEdJX3ygGoux6inyVantUKmKaAK7IBm', '1', '2018-04-19 12:59:53', '2018-04-19 12:59:53', 1, 'himself');
...
ALTER TABLE `courses`
  ADD PRIMARY KEY (`id`),
  ADD KEY `is_course_active` (`is_active`);
...
ALTER TABLE `enrollments`
  ADD PRIMARY KEY (`id`),
  ADD UNIQUE KEY `ix_uq` (`student_id`,`student_active`,`course_id`,`course_active`,`added_by`),
  ADD KEY `is_student_active` (`student_active`),
  ADD KEY `is_course_active` (`course_active`);
...
ALTER TABLE `students`
  ...
  ADD KEY `is_students_active` (`is_active`);
